...
class KfAccountAPITest(BaseAPITest):
    ...
    def test_get_kf_accounts(self):
        ...
        success, response = self.make_request("GET", "/api/kf-accounts/", params=params)
    ...
    def test_add_kf_account(self):
        ...
        success, response = self.make_request("POST", "/api/kf-accounts/", json=data)
    ...
    def test_get_kf_account_link(self):
        ...
        open_kfid = "kf001@abc"
        params = {"corp_id": self.corp_id}
        success, response = self.make_request("GET", f"/api/kf-accounts/{open_kfid}/link", params=params)
    ...
    def test_get_customer_info(self):
        ...
        params = {"corp_id": self.corp_id}
        success, response = self.make_request("GET", f"/api/kf-accounts/customer/{external_userid}", params=params)
    ...
    def test_update_kf_account(self):
        ...
        success, response = self.make_request("PUT", f"/api/kf-accounts/{open_kfid}", json=data)
    ...
    def test_delete_kf_account(self):
        ...
        # 使用测试的客服ID
        open_kfid = "kf001@abc"
        data = {"corp_id": self.corp_id}
        success, response = self.make_request("DELETE", f"/api/kf-accounts/{open_kfid}", json=data)
...
class MediaAPITest(BaseAPITest):
    ...
    def test_upload_temp_media(self):
        ...
        with tempfile.NamedTemporaryFile(suffix=".txt", delete=False, mode='w', encoding='utf-8') as tmp:
            tmp.write("这是一个测试文件内容")
            tmp_path = tmp.name

        try:
            files = {
                "file": (tmp_path, open(tmp_path, "rb"), "text/plain")
            }
            params = {
                "corp_id": self.corp_id,
                "media_type": "file"
            ...
            success, response = self.make_request("POST", "/api/media/upload", files=files, params=params)
    ...
    def test_get_temp_media(self):
        ...
        success, response = self.make_request("GET", f"/api/media/test_media_id_123", params=params)
    ...
    def test_download_temp_media(self):
        ...
        success, response = self.make_request("GET", f"/api/media/download/test_media_id_123", params=params)
...
class CallbackAPITest(BaseAPITest):
    ...
    def test_customer_service_callback(self):
        ...
        success, response = self.make_request("POST", "/callback/customer-service",
    ...
    def test_suite_callback(self):
        ...
        success, response = self.make_request("POST", "/callback/suite",
                                              headers={"Content-Type": "application/x-www-form-urlencoded"},
                                              data=data)
    ...
    def test_provider_callback(self):
        ...
        success, response = self.make_request("POST", "/callback/provider",
                                              headers={"Content-Type": "application/x-www-form-urlencoded"},
                                              data=data)
